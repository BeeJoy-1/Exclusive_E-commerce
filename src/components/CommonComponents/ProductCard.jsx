            ...
            <Link to={`/ProductDetail/${itemData._id}`} className="block">
              <div className="h-[152px] flex-1 ">
                <img
                  ...
                  alt={p1}
                  className="h-full w-full object-contain mt-5 z-20"
                />
              </div>
            </Link>
            <span className="flex items-center justify-center w-[35px] h-[35px] rounded-full bg-white_FFFFFF text-xl cursor-pointer hover:bg-text_reddb4444 hover:text-white_FFFFFF transition-all mt-2 absolute right-0 z-10">
