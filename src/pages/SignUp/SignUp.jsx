      ...
      <div class="bg-white container">
        <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
          <div class="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
            <img
              alt=""
              src="https://images.pexels.com/photos/30698435/pexels-photo-30698435/free-photo-of-commercial-jet-airplane-landing-in-geneva.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
