...
import ProfileCard from "../../components/AboutComponent/ProfileCard";
        ...
        <div className="flex items-center justify-between mt-[140px]">
          {reviewsObject?.map((item) => (
            <div
              ...
              key={item.id}
            >
              <div className="w-[350px] border rounded-lg p-6 shadow-md text-center cursor-pointer group-hover:bg-text_black000000 transition-all">
                {/* Icon Circle */}
